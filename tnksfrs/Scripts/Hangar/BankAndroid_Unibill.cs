...
////                {AFInAppEventParameterName.REVENUE, p.item.priceInLocalCurrency.ToString()},
////                {AFInAppEventParameterName.CURRENCY, p.item.isoCurrencySymbol},
////                {AFInAppEventParameterName.CONTENT_ID, p.item.Id},
////            });

////        //AppsFlyerImpl.SendMessageToAppsFlyerServer(AppsFlyerImpl.AFEvent.InappPurchaseVerified,
////        //	new Dictionary<string,string>(){{"id",p.item.LocalId}, {"name",p.item.name}, {"count",Unibiller.GetPurchaseCount(p.item).ToString()}, { "receipt", p.receipt }});
...
//        //    new Dictionary<string, string>() {
//        //        {AFInAppEventParameterName.PRICE, p.item.priceInLocalCurrency.ToString()},
//        //        {AFInAppEventParameterName.CURRENCY, p.item.isoCurrencySymbol},
//        //        {AFInAppEventParameterName.CONTENT_ID, p.item.Id},
//        //    }
//        //);
//   //     AppsFlyerImpl.SendMessageToAppsFlyerServer(AppsFlyerImpl.AFEvent.InappPurchaseFailed,
//            //new Dictionary<string, string>() { { "id", p.item.LocalId }, { "name", p.item.name }, { "count", Unibiller.GetPurchaseCount(p.item).ToString() }, { "receipt", p.receipt } });
//    }
