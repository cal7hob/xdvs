...
public class Quest
{
    ...
    public string BattleStatsDictionaryKey
    {
        get; set;
    }
    ...
    public string LocalizedDescription
    {
        get
        {
            return type == Type.Revenge
                ? Localizer.GetText(LocalizationKey)
                : Localizer.GetText(LocalizationKey, CompleteCount);
        }
    }

    public ProfileInfo.Price CurReward
    {
        get
        {
            return ProfileInfo.IsPlayerVip ? VipReward : Reward;
        }
    }
...
public static class QuestsInfo
{
    ...
    public static ProfileInfo.Price CurRewardForThreeQuests
    {
        get
        {
            return ProfileInfo.IsPlayerVip ? VipRewardForAllQuests : RewardForAllQuests;
        }
    }
