...
{	
	...
	public class Module
	{
		public XD.ModuleType type;
		public XD.VehicleParameter primaryParameter;
		public XD.VehicleParameter secondaryParameter;
		...
		public static Module FromDictionary(JSONObject dict)
		{
			...
			info.type = (XD.ModuleType)Enum.Parse(typeof(XD.ModuleType), (string)dict["type"]);
			info.primaryParameter = (XD.VehicleParameter)Enum.Parse(typeof(XD.VehicleParameter), (string)dict["primaryParameter"]);
			info.secondaryParameter = (XD.VehicleParameter)Enum.Parse(typeof(XD.VehicleParameter), (string)dict["secondaryParameter"]);
