...
namespace BankKits
{
    ...
    public class Data
    {
        ...
        public string PrefabPath { get{ return string.Format("{0}/GuiPrefabs/Hangar/BankKits/{1}/{2}", XD.StaticContainer.GameManager.CurrentResourcesFolder, type, PrefabName); }}
