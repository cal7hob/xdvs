#if !UNITY_STANDALONE_WIN && !NETFX_CORE
using System;
...
namespace Odnoklassniki
{
	public sealed class OK : ScriptableObject
	{
	    ...
	    public static DateTime AccessTokenExpiresAt { get { return OdnoklassnikiImpl.AccessTokenExpiresAt;  } }
	    public static bool IsRefreshTokenValid { get { return OdnoklassnikiImpl.IsRefreshTokenValid; } }
...
#region Debug tools
        ...
        public static void RefreshAccessToken(OKRefreshTokenCallback action)
	    {
	        OdnoklassnikiImpl.RefreshAccessToken(action);
	    }
	}
}
#endif