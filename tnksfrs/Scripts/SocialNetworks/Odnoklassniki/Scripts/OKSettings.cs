...
namespace Odnoklassniki
{
	...
	public class OKSettings : ScriptableObject
	{
        ...
        const string OdnoklassnikiSettingsPath = "Scripts/SocialNetworks/Odnoklassniki/Resources";
			...
			get
			{
				if (instance == null)
				{
					...
					if (instance == null)
					{
						...
						{
                            AssetDatabase.CreateFolder("Assets/Scripts/SocialNetworks/Odnoklassniki", "Resources");
						}
