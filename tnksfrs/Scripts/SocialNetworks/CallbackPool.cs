...
public class CallbackPool : MonoSingleton<CallbackPool>
{
	...
	public Callback getCallback(CallbackType callbackType)
	{
		...
		switch (callbackType)
		{
			...
			default:
                #if DEBUG_TAG_TF
				Debug.Log("TF: CallbackPool: Wrong callbackType" + callbackType.ToString());	
                #endif
				break;
		}
	...
	{
#if DEBUG_TAG_TF
		Debug.LogError("TF: callbackHandler fired with resutlString: \n"+resultString);
#endif
		...
		Debug.Log("TF: callbackId="+callbackId);
		...
		{
#if DEBUG_TAG_TF
			Debug.Log("TF: CallbackPool: callback "+callbackId+" is empty");
#endif
		}
