    ...
    public class Response
    {
        ...
        public Response (Request request, bool doDecodeNow = true) {
            ...
            if (!string.IsNullOrEmpty (m_request.Result.error)) {
                ...
                Debug.LogWarning ("Request error: " + m_error);
                return;
            }
            ...
            if (dataSig != incomingSig) {
                ...
                Manager.dbg ("Response body: ".RichString("color:cyan") + m_request.Result.text);
                return;
            }
        ...
        void AnalyzeResponse ()
        {
            ...
            {
                ProfileInfo.AppGUID = m_data.ExtractOrDefault<string>("device");
            }
