...
public class AppsFlyerImpl : MonoBehaviour
{
    ...
    [SerializeField]
    private string appIdIOS = "1211576995";//У поциков Устанавливается скриптом  AppsFlyerOptions в переключалке
    [SerializeField]
    private string appIdAndroid = "com.extremedevelopers.tankforce";
    [SerializeField]
    private string appIdUWP = "9p26r81l3j3f";
    ...
    void Awake()
    {
        if (Instance == null)
        {
            ...
            AppsFlyer.setAppID(GetAppIdForCurPlatform());
    ...
    private string GetAppIdForCurPlatform()
    {
#if UNITY_IOS
        return appIdIOS;
#elif UNITY_ANDROID
