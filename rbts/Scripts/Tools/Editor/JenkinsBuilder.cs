...
public class JenkinsBuilder
{
    ...
    private class Services : Dictionary<string, XDevs.AppBuild.Service>
    {
        public Services()
        {
            this["ResourcesSwitcher"] = new XDevs.AppBuild.ResourcesSwitcher();
            this["BuildSettings"] = new XDevs.AppBuild.BuildSettingsOptions();
            this["PlayerSettings"] = new XDevs.AppBuild.PlayerSettingsOptions();
#if UNITY_ANDROID
            this["PlayServices"] = new XDevs.AppBuild.PlayServicesOptions ();
#endif
            this["UnityPurchasing"] = new XDevs.AppBuild.UnityPurchasingOptions();
            this["Facebook"] = new XDevs.AppBuild.FacebookOptions();
            this["PushWoosh"] = new XDevs.AppBuild.PushwooshOptions();
            this["AndroidManifest"] = new XDevs.AppBuild.AndroidManifestOptions();
            this["GoogleAnalytics"] = new XDevs.AppBuild.GoogleAnalyticsOptions();
            this["Tutorials"] = new XDevs.AppBuild.TutorialsOptions();
#if UNITY_ANDROID || UNITY_IOS
            this["UnityAds"] = new XDevs.AppBuild.UnityAdsOptions();
            this["Chartboost"] = new XDevs.AppBuild.ChartboostOptions();
#endif

            GameSetup gameSetup = new XDevs.AppBuild.GameSetup();
            BuildGameSwitcher.Version = gameSetup.GameDataScript.GetPlayerBundleVersion(); //fix
            this["GameSetup"] = gameSetup;
            this["AppsFlyerOptions"] = new XDevs.AppBuild.AppsFlyerOptions();
            this["VkontakteOptions"] = new XDevs.AppBuild.VkontakteOptions();
#if UNITY_ANDROID || UNITY_IOS
            this["OdnoklassnikiOptions"] = new XDevs.AppBuild.OdnoklassnikiOptions();
#endif
            UpdateData();
        }
    ...
    private void StateControl()
    {
        ...
        if (state == CyclicBuildState.WaitSwichPlatform.ToString()) //for (int i = 0; i < 200; i++)
        {
            ...
            if (EditorUserBuildSettings.activeBuildTarget != commandLineArgs.buildPlatform)
            {
                ...
                EditorUserBuildSettings.SwitchActiveBuildTarget(commandLineArgs.buildPlatform);
