...
public class TankBotController : TankController
{
    ...
    protected override float TurretAxisControl { get { return turretAxisControl; } }
    protected override bool FireButtonPressed { get { return (!PhotonView.isMine && burst) || tankBotAI.FireButtonPressed; } }
    ...
    public override void UpdateBotPrefabs(VehicleController nativeController)
    {
        ...
        explosionFxInfo = tankController.explosionFxInfo;
        shotFXInfo = tankController.shotFXInfo;
        ...
        shellId = tankController.shellId;
        crashModelResource = tankController.crashModelResource;
    }
