...
public class SwipeLessonAnimation : MonoBehaviour
{
    ...
    void Awake()
    {
        Messenger.Subscribe(EventId.BattleTutorialSkipping, OnBattleTutorialSkipping);
    }

    void OnDestroy()
    {
        Messenger.Unsubscribe(EventId.BattleTutorialSkipping, OnBattleTutorialSkipping);
    }
