...
public class FuelBarManager : MonoBehaviour
{
    ...
    protected virtual void Init()
    {
        ...
        Messenger.Subscribe(EventId.FuelUpdated, FuelUpdatedHandler);
        Messenger.Subscribe(EventId.MaxFuelUpdated, MaxFuelUpdatedHandler);
    ...
    {
        Messenger.Unsubscribe(EventId.FuelUpdated, FuelUpdatedHandler);
        Messenger.Unsubscribe(EventId.MaxFuelUpdated, MaxFuelUpdatedHandler);
        _instance = null;
    }
