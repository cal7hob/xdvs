...
#pragma warning restore 67
    ...
    /// Во ВКонтакте нет возможности узнать, кого игрок пригласил, и пригласил ли вообще.
    /// https://vk.com/dev/clientapi?f=5.%20showInviteBox
    /// https://vk.com/dev/game_invites
    ...
    public IEnumerator CheckGroupMembership(Action<bool> OnComplete)
    {
        ...
        {
            { "user_id", UserId },
            { "group_id", GameData.socialGroups["vk"] }
        };
                ...
                { 
                    ...
                    GoogleAnalyticsWrapper.LogEvent(
                        new CustomEventHitBuilder()
                            ...
                            .SetParameter(GAEvent.Action.GotViaVKInvitation)
