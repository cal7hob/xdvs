...
namespace SocialNetworks.Avatars
{
    public class Registry : MonoBehaviour
    {
        ...
        public tk2dSpriteCollectionData Collection { get { return spriteCollection; } }
        ...
        protected void Awake ()
        {
            ...
            Vector2 anchorPos = tk2dSpriteGeomGen.GetAnchorOffset(tk2dBaseSprite.Anchor.MiddleCenter, avatarSize, avatarSize);
            ...
            spriteCollection = tk2dRuntime.SpriteCollectionGenerator.CreateFromTexture(
                ...
                atlas,
                scs,
                new Vector2(atlas.width, atlas.height),
                names,
                regions,
                null,
                anchors,
        ...
        protected tk2dSpriteCollectionData spriteCollection;
