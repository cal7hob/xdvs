...
public class SocialSettings : MonoBehaviour
{
    ...
    {
        platform = (SocialPlatform)Enum.Parse(typeof(SocialPlatform), platform_js, true);
        
        switch (platform)
        {
            case SocialPlatform.Facebook:
                service = gameObject.AddComponent<SocialNetworks.Facebook>();
                break;
            case SocialPlatform.Odnoklassniki:
                service = gameObject.AddComponent<SocialNetworks.Odnoklassniki>();
                break;
            case SocialPlatform.Vkontakte:
                service = gameObject.AddComponent<VKManager>();
                break;
            case SocialPlatform.Mail:
                service = gameObject.AddComponent<Moimir>();
                break;
        }
    ...
    private void OnSocialInitialized(ISocialService socialService, SocialInitializationState initializationState)
    {
        ...
        {
            Messenger.Send(EventId.AfterWebPlatformDefined, new EventInfo_SimpleEvent());
        }
    }
