...
namespace XDevs.Loading {
    public class ServerChooser : MonoBehaviour {
        ...
        void Awake () {
            ...
            Messenger.Subscribe (EventId.AfterWebPlatformDefined, StartInit, 1);
        }

        void OnDestroy () {
            Messenger.Unsubscribe (EventId.AfterWebPlatformDefined, StartInit);
        }
        ...
        void ServerChoosed (Http.Server server) {
            ...
            Messenger.Send (EventId.ProfileServerChoosed, new EventInfo_SimpleEvent ());
        }
