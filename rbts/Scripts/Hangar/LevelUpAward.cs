...
public class LevelUpAward : MonoBehaviour, IQueueablePage
{
    ...
    private void Awake()
    {
        Messenger.Subscribe(EventId.AfterHangarInit, CheckForLevelUpPopup);
    }

    private void OnDestroy()
    {
        Messenger.Unsubscribe(EventId.AfterHangarInit, CheckForLevelUpPopup);
    }
    ...
    public void BeforeActivation()
    {
        ...
        if (ProfileInfo.Level > ProfileInfo.lastLevelUpAward)
        {
            ...
            if (SocialSettings.IsWebPlatform && !Enum.IsDefined(typeof(AchievementsIds.Id), ProfileInfo.Level))
