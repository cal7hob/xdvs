...
public class MapFramesCreator : MonoBehaviour
{
    ...
    {
        Instance = this;
        Messenger.Subscribe(EventId.AfterHangarInit, AfterHangarInit);
        Messenger.Subscribe(EventId.PlayerLevelChanged, OnPlayerLevelChanged);
    ...
    {
        Instance = null;
        Messenger.Unsubscribe(EventId.AfterHangarInit, AfterHangarInit);
        Messenger.Unsubscribe(EventId.PlayerLevelChanged, OnPlayerLevelChanged);
