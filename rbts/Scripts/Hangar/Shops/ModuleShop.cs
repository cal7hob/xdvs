...
public class ModuleShop : Shop<ShopItemCell>
{
    ...
    private void ModuleClick(string buttonName, bool clickSimulate)
    {
        ...
        HangarModuleWindow.SetData(ModuleInView.type, level, maxLevel, Shop.CurrentVehicle.HangarVehicle.Info.vehicleType);
    ...
    private void OnModuleLevelChanged(TankModuleInfos.ModuleType type, int level)
    {
        ...
        HangarController.Instance.FillParameterDelta(
            ...
            max: HangarController.Instance.DPMMax[Shop.CurrentVehicle.Info.vehicleGroup],
            prim: UserVehicle.CalcDPM(
                        damage: primaryParameters[VehicleInfo.VehicleParameter.Damage],
                        rof: primaryParameters[VehicleInfo.VehicleParameter.RoF],
                        vehicleType: Shop.CurrentVehicle.Info.vehicleType),
            sec: UserVehicle.CalcDPM(
                        damage: secondaryParameters[VehicleInfo.VehicleParameter.Damage],
                        rof: secondaryParameters[VehicleInfo.VehicleParameter.RoF],
                        vehicleType: Shop.CurrentVehicle.Info.vehicleType));
    ...
    public void ModuleReceived(UserVehicle vehicle, TankModuleInfos.ModuleType moduleType)
    {
        ...
        Messenger.Send(EventId.ModuleReceived, null);

        HangarController.Instance.PlayGUISound(HangarController.Instance.moduleInstallSound);
    }
            ...
            successCallback:    delegate(Http.Response result)
                                {
                                    ...
                                    Messenger.Send(EventId.ModuleBought, new EventInfo_I(HangarModuleWindow.Level));  
                                },
    ...
    {
        HangarController.Instance.isWaitingForSaving = true;
        DeliverBox.SetButtonActivated(false);
