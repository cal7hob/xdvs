...
public class WeeklyAwards : MonoBehaviour, IQueueablePage
{
    ...
    {
        Instance = this;
        Messenger.Subscribe(EventId.AfterHangarInit, EnqueueWeeklyAwards);
        Messenger.Subscribe(EventId.WeeklyAwardsChanged, WeeklyAwardsChanged);
    }
    ...
    void OnDestroy()
    {
        Messenger.Unsubscribe(EventId.AfterHangarInit, EnqueueWeeklyAwards);
        Messenger.Unsubscribe(EventId.WeeklyAwardsChanged, WeeklyAwardsChanged);
        Instance = null;
    }
    ...
    public void EnqueueWeeklyAwards(EventId id, EventInfo info)
    {
        ...
        Messenger.Send(EventId.WeeklyAwardsChanged, null);
    }
