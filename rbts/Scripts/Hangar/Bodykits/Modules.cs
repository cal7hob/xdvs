...
public class Modules : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        Messenger.Subscribe(EventId.TankJoinedBattle, OnTankJoinedBattle);
        Messenger.Subscribe(EventId.HangarVehicleGeometryLoaded, OnHangarVehicleGeometryLoaded);
    ...
    void OnDestroy()
    {
        ...
        Messenger.Unsubscribe(EventId.TankJoinedBattle, OnTankJoinedBattle);
        Messenger.Unsubscribe(EventId.HangarVehicleGeometryLoaded, OnHangarVehicleGeometryLoaded);
