...
public class VipShopPage : MonoBehaviour
{
    ...
    void Awake()
    {
        Messenger.Subscribe(EventId.PageChanged, OnPageChanged);
        Messenger.Subscribe(EventId.VipStatusUpdated, OnVipStatusUpdated);
        Init();
    }
    ...
    {
        Messenger.Unsubscribe(EventId.VipStatusUpdated, OnVipStatusUpdated);
        Messenger.Unsubscribe(EventId.PageChanged, OnPageChanged);
    }
