...
namespace XDevs.Scores.Animation
{
    public class ScoresAnimationManager : MonoBehaviour, IQueueablePage
    {
        ...
        {
            Instance = this;
            Messenger.Subscribe(EventId.ScoresHighlightedItemsReady, OnScoresHighlightedItemsReady);
            Messenger.Subscribe(EventId.FriendsScoresHighlightedItemsReady, OnFriendsScoresHighlightedItemReady);
        }

        private void OnDestroy()
        {
            Messenger.Unsubscribe(EventId.ScoresHighlightedItemsReady, OnScoresHighlightedItemsReady);
            Messenger.Unsubscribe(EventId.FriendsScoresHighlightedItemsReady, OnFriendsScoresHighlightedItemReady);
            Instance = null;
        }
