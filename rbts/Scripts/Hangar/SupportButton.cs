...
public class SupportButton : MonoBehaviour
{
    ...
    private void Awake()
    {
        Messenger.Subscribe(EventId.AfterHangarInit, ApplyUnreadMessages);
        Messenger.Subscribe(EventId.ProfileInfoLoadedFromServer, ApplyUnreadMessages);
    ...
    {
        Messenger.Unsubscribe(EventId.AfterHangarInit, ApplyUnreadMessages);
        Messenger.Unsubscribe(EventId.ProfileInfoLoadedFromServer, ApplyUnreadMessages);
        cachedFeedbackButton.OnClick -= Clicked;
    }
