...
public class UserVehicle
{
    ...
    public void EndCamouflageTrialWith(Pattern camo = null)
    {
        ...
        if (camo == null)
        {
            BodykitController.ResetCamouflage();
            return;
        }
    ...
    public Dictionary<VehicleInfo.VehicleParameter, ObscuredFloat> GetRealParameters(bool ignoreCamo = false, bool ignoreDecal = false, bool ignoreModule = false)
    {
        ...
        _parameters.Add(VehicleInfo.VehicleParameter.Magazine, Info.baseMagazine);
    ...
    private void ExpiredCamouflageRemoving()
    {
        ...
        {
            Messenger.Send(EventId.PatternExpired, new EventInfo_I(upgrades.CamouflageId));
    ...
    private void ExpiredDecalRemoving()
    {
        ...
        {
            Messenger.Send(EventId.DecalExpired, new EventInfo_I(upgrades.DecalId));
    ...
    public static int CalcDPM(float damage, float rof, VehicleInfo.VehicleType vehicleType)
    {
        return (int)(damage * rof);
    }
}