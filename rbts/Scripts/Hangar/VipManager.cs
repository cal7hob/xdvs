...
public class VipManager : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        Messenger.Subscribe(EventId.ProfileInfoLoadedFromServer, VipStatusUpdated_Handler);
        Messenger.Subscribe(EventId.PageChanged, PageChanged_Handler);
        Messenger.Subscribe(EventId.OnLanguageChange, LanguageChanged_Handler);
        Messenger.Subscribe(EventId.AfterHangarInit, VipManagerInit);

        ExpirationTime = ProfileInfo.VipExpirationDate - (int)GameData.CorrectedCurrentTimeStamp;
        Messenger.Send(EventId.VipStatusUpdated, new EventInfo_B(ProfileInfo.IsPlayerVip));
    }
    ...
    void OnDestroy()
    {
        ...
        Messenger.Unsubscribe(EventId.ProfileInfoLoadedFromServer, VipStatusUpdated_Handler);
        Messenger.Unsubscribe(EventId.PageChanged, PageChanged_Handler);
        Messenger.Unsubscribe(EventId.OnLanguageChange, LanguageChanged_Handler);
        Messenger.Unsubscribe(EventId.AfterHangarInit, VipManagerInit);
    ...
    {
        Messenger.Send(EventId.VIPAccountPurchased, new EventInfo_SimpleEvent());
    ...
    public void SetVipOffers()
    {
        ...
        IsInitialized = true;
        Messenger.Send(EventId.VipOffersInstantiated, new EventInfo_SimpleEvent());
    }
