...
namespace BankKits
{
    ...
    public class Data
    {
        ...
        public KitBehaviour kitBehaviour;
        ...
        public string PrefabPath { get{ return string.Format("{0}/GuiPrefabs/Hangar/BankKits/{1}/{2}", GameManager.CurrentResourcesFolder, type, PrefabName); }}
    ...
    public class KitBehaviour : MonoBehaviour
    {
        ...
        [SerializeField]
        private tk2dTextMesh lblTimeRemains;
        [SerializeField]
        private tk2dTextMesh lblDisplayedAmount;
        ...
        private void Awake()
        {
            Messenger.Subscribe(EventId.HangarTimerTick, OnTimerTick);
        }

        private void OnDestroy()
        {
            Messenger.Unsubscribe(EventId.HangarTimerTick, OnTimerTick);
        }
