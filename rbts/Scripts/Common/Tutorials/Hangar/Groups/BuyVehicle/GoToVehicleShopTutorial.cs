...
public class GoToVehicleShopTutorial : Tutorial
{
    ...
    {
        Messenger.Subscribe(EventId.ProfileInfoLoadedFromServer, CheckMoney);
        base.Awake();
    }

    protected override void OnDestroy()
    {
        Messenger.Unsubscribe(EventId.ProfileInfoLoadedFromServer, CheckMoney);
        base.OnDestroy();
    }
    ...
    protected override IEnumerator RefreshingRoutine()
    {
        ...
        {
            didPlayVoice = true;
            Messenger.Send(EventId.VoiceRequired, new EventInfo_I((int)VoiceEventKey.BuyNewVehicleLesson));
        }
    }
}
