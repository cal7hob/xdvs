...
public abstract class BattleTutorial : MonoBehaviour
{
    ...
    public BattleLessons CurrentBattleLesson
    {
        ...
        set
        {
            ...
            Messenger.Send(EventId.BattleLessonStarted, new EventInfo_I((int)currentBattleLesson));
        }
    }
    ...
    {
        get { return GameData.IsGame(Game.Armada) ? 2 : goalBotKills; }
    }
    ...
    protected Vector3 ArrowPosition
    {
        get
        {
            ...
            if (GameData.IsGame(Game.ToonWars))
                return new Vector3(0.0f, 2.75f, 9.0f);

            if (GameData.IsGame(Game.SpaceJet))
                return new Vector3(0.0f, 6.5f, -9.0f);
    ...
    protected virtual void Awake()
    {
        ...
        Messenger.Subscribe(EventId.BattleGUIIntialized, Init, 4);
        Messenger.Subscribe(EventId.BattleEnd, OnBattleEnd);
        Messenger.Subscribe(EventId.VehicleKilled, CountBotKills);
        Messenger.Subscribe(EventId.StatTableVisibilityChange, OnStatTableChangeVisibility);
        Messenger.Subscribe(EventId.OnExitToHangar, Complete);
    }
    ...
    protected virtual void OnDestroy()
    {
        ...
        Messenger.Unsubscribe(EventId.BattleGUIIntialized, Init);
        Messenger.Unsubscribe(EventId.BattleEnd, OnBattleEnd);
        Messenger.Unsubscribe(EventId.ItemTaken, OnPickUpBonus);
        Messenger.Unsubscribe(EventId.VehicleKilled, CountBotKills);
        Messenger.Unsubscribe(EventId.StatTableVisibilityChange, OnStatTableChangeVisibility);
        Messenger.Unsubscribe(EventId.OnExitToHangar, Complete);
    }
    ...
    protected virtual void Init(EventId id, EventInfo info)
    {
        ...
        GUIControlSpriteGroups.SetActiveSpriteGroups(GUIControlSpriteGroups.Everything, false);
    ...
    {
        Messenger.Send(EventId.BattleTutorialSkipping, new EventInfo_SimpleEvent());
    ...
    protected IEnumerator CheckIfPickUpBonusLessonIsDone()
    {
        ...
        Messenger.Subscribe(EventId.ItemTaken, OnPickUpBonus);
        ...
        Messenger.Send(EventId.BattleLessonAccomplished, new EventInfo_I((int)BattleLessons.pickUpBonus));
        Messenger.Unsubscribe(EventId.ItemTaken, OnPickUpBonus);
    }
    ...
    public virtual IEnumerator CheckIfMoveLessonIsDone()
    {
        ...
        Messenger.Send(EventId.BattleLessonAccomplished, new EventInfo_I((int)BattleLessons.move));
    }
    ...
    protected virtual IEnumerator FireLesson()
    {
        ...
        Messenger.Send(EventId.BattleLessonAccomplished, new EventInfo_I((int)BattleLessons.fire));
    ...
    public virtual IEnumerator KillEnemiesLesson()
    {
        ...
        Messenger.Send(EventId.BattleLessonAccomplished, new EventInfo_I((int)BattleLessons.killEnemies));
    ...
    public IEnumerator GreetingsCommander()
    {
        ...
        Messenger.Send(EventId.VoiceRequired, new EventInfo_I((int)VoiceEventKey.GreetingsComander));
        yield return new WaitForSeconds(4);

        Messenger.Send(EventId.BattleLessonAccomplished, new EventInfo_I((int)BattleLessons.greetings));
