...
public class FriendsManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        Messenger.Subscribe(EventId.AfterFacebookMainInfoLoaded, Handler);
    }
    ...
    private void OnDestroy()
    {
        ...
        Messenger.Unsubscribe(EventId.AfterFacebookMainInfoLoaded, Handler);
        Instance = null;
    }
    ...
    private static void GetSocialFriends()
    {
        ...
        if (socialFriendsUids.Count > 0)
        {
		    ...
		    if (social.Equals("moimir")) social = "mailru";
        }
    ...
    private static IEnumerator FriendsUpdated(Response result)
    {
        ...
        switch (data.ValueInt("status"))
        {
            ...
            case 1:
                ...
                Messenger.Send(EventId.FriendsScoresHighlightedItemsReady, null);
                break;
        }
    }
}
