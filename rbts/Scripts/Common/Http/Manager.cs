...
namespace Http
{
    ...
    class Manager : MonoBehaviour
    {
        ...
        #region Servers list
        private Dictionary<Interface, List<Server>> servers = new Dictionary<Interface, List<Server>>
        {
            ...
            { Interface.FutureTanks, new List<Server> {
                    new Server (WorldRegion.Debug,  "http",  "irontanks-team.scifi-tanks.com", "d"),
                    new Server (WorldRegion.Europe, "https", "futuretanks.extreme-developers.com", "e")
                }
            },
            { Interface.ToonWars, new List<Server> {
                    new Server (WorldRegion.Debug,  "http",  "cartoontanks.scifi-tanks.com", "d"),
                    new Server (WorldRegion.Europe, "https", "toonwars.extreme-developers.com", "e")
                }
            },
            { Interface.ApocalypticCars, new List<Server> {
                    new Server (WorldRegion.Debug,  "http",  "apocalypticcars.scifi-tanks.com", "d"),
                    new Server (WorldRegion.Europe, "https", "apocalypticcars.extreme-developers.com", "e")
                }
            },
            ...
            { Interface.BattleOfWarplanes, new List<Server> {
                    new Server (WorldRegion.Debug,  "http",  "battlefighters.scifi-tanks.com", "d"),
            ...
            { Interface.BattleOfHelicopters, new List<Server> {
                    new Server (WorldRegion.Debug,  "http",  "battleofhelicopters.scifi-tanks.com", "d"),
            ...
            { Interface.WWR, new List<Server> {
                    new Server (WorldRegion.Debug,  "http",  "wwr.scifi-tanks.com", "d"),
                    new Server (WorldRegion.Europe, "https", "wwr.extreme-developers.com", "e")
                }
            },
            { Interface.FTRobotsInvasion, new List<Server> {
                    new Server (WorldRegion.Debug,  "http",  "tvr.scifi-tanks.com", "d"),
                    new Server (WorldRegion.Europe, "https", "tvr-eu.extreme-developers.com", "e"),
                    new Server (WorldRegion.Asia, "https", "tvr-sg.extreme-developers.com", "a"),
                }
            },
        };
        #endregion
