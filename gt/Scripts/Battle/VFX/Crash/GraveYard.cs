...
public class GraveYard : MonoBehaviour
{
    ...
    public IEnumerator SetVisible(bool activate) 
    {
        // включаем могилу на кадр позже, после TankKilled , чтобы не было видно глюк с шейдером обводки. (окрашивает могилу в красный)
        yield return null;
