...
public class CursorManager : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        Dispatcher.Subscribe(EventId.FullScreenStateChanged, OnFullScreenStateChanged);
    ...
    void OnDestroy()
    {
        ...
        Dispatcher.Unsubscribe(EventId.FullScreenStateChanged, OnFullScreenStateChanged);
    ...
    private static void OnFullScreenStateChanged(EventId id, EventInfo info)
    {
        if (IsGUIOnScreen)
        {
            return;
