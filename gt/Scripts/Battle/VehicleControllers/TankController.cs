...
public class TankController : VehicleController
{
    ...
    public void Shoot(int victimId, Vector3 position, int damage)
    {
        ...
        Dispatcher.Send(EventId.TankTakesDamage, new EventInfo_U(victimId, damage, data.playerId, (int)StaticContainer.DefaultShellType, hitPoint));
