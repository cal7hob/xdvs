...
public class JoystickManager : MonoBehaviour
{
    ...
    //Методы для отображения мёртвых зон для джойстика поворота башни. Включаем для откладки мёртвых зон. Не удалять
    ...
    //    foreach (var deadZones in ScreenJoystick.joyAreaException)
    //    {
    //        EditorGUI.DrawRect(reYcoordforOnGUI(deadZones), color);
    //    }
    //}
}
