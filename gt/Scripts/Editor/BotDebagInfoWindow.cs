...
";
    ...
    private void FillTable()
    {
        GUILayout.BeginHorizontal(GUI.skin.box);
            ...
            DrawTableColumn("ClosestVehicle", true);
            DrawTableColumn("ClosestEnemyVehicle", true);
        ...
        foreach (var bot in bots)
        {
            ...
            GUILayout.BeginHorizontal();
                ...
                DrawTableColumn(bot.BotAI.ClosestVehicle == null ? null : bot.BotAI.ClosestVehicle.data.playerName);
                DrawTableColumn(bot.BotAI.ClosestEnemyVehicle == null ? null : bot.BotAI.ClosestEnemyVehicle.data.playerName);
                ...
                DrawTableColumn(bot.BotAI.Target ? bot.BotAI.Target.data.playerName : null);
        ...
        foreach(var bot in bots)
        {
            ...
            Handles.Label(bot.IndicatorPointPosition,
                string.Format(
                    ...
                    bot.BotAI.ClosestVehicle == null ? null : bot.BotAI.ClosestVehicle.data.playerName,
                    bot.BotAI.ClosestEnemyVehicle == null ? null : bot.BotAI.ClosestEnemyVehicle.data.playerName), textStyle);
        }
    }
