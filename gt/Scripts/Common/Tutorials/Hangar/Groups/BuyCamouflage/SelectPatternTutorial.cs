...
public class SelectPatternTutorial : GoToPatternShopTutorial
{
    ...
    protected override void Awake()
    {
        ...
        Dispatcher.Subscribe(EventId.PatternSelected, OnShopItemSelected);
        Dispatcher.Subscribe(EventId.PatternShopFilled, OnPatternShopFilled);
    }
    ...
    protected override void OnDestroy()
    {
        ...
        Dispatcher.Unsubscribe(EventId.PatternSelected, OnShopItemSelected);
        Dispatcher.Unsubscribe(EventId.PatternShopFilled, OnPatternShopFilled);
    }
    ...
    private void TryInstantiateArrow()
    {
        ...
        arrow = MenuController.InstantiateTutorialPart(
                holder:         holder,
