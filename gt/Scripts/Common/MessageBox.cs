...
public class MessageBox : MonoBehaviour
{
    ...
    private string PageOverMessageBoxStartShow;//Для устранения бага с BlackAlphaLayer когда месседж бокс стартанул на одной странице с БАЛ а закончился на другой, без БАЛ и утащил БАл за собой. 
    ...
    private void SetActive(bool en)
    {
        ...
        if (en)
        {
            ...
            PageOverMessageBoxStartShow = GUIPager.ActivePage;
        }
        else
        {
            if (GUIPager.ActivePage != PageOverMessageBoxStartShow)
            {
                wasBlackAlphaLayerEnabled = false;
            }
