...
namespace Http
{
    ...
    class Manager : MonoBehaviour
    {
        ...
        {
            { Interface.WWT2, new List<Server> {
                    new Server (WorldRegion.Debug,  "http",  "grandtanks.scifi-tanks.com", "d"),
                    new Server (WorldRegion.Europe, "https", "grandtanks-eu.extreme-developers.com", "e"),
                    new Server (WorldRegion.Asia,   "https", "grandtanks-sg.extreme-developers.com", "a"),
                }
            },
        };
        #endregion
