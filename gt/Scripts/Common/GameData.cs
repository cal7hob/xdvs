...
public class GameData : MonoBehaviour
{
    ...
    public const int TUTORIAL_VEHICLE_ID = 9; // TODO: поменять на актуальный.
    ...
    public static string GetInterfaceShortName(Interface customInterface)
    {
        ...
        {
            case Interface.WWT2: return "WWT2";
    ...
    public static Interface CurInterface
    {
        get
        {
            ...
            {
                if (UnityEditor.PlayerSettings.applicationIdentifier == androidBundleIds[Game.WWT2] ||
                    UnityEditor.PlayerSettings.applicationIdentifier == androidBundleIds[Game.WWT2Amazon])
                {
                    return Interface.WWT2;
                }
                else
                {
    ...
    public static Dictionary<Game, string> androidBundleIds = new Dictionary<Game, string>() {
        {Game.WWT2,              "com.extremedevelopers.grandtanks"},
        {Game.WWT2Amazon,        "com.extremedevelopers.grandtanks"},
