...
public class UserRemapKeyboard : HangarPage
{
    ...
    [Header("Key For PlayerPrefs")]
    public string PlayerPrefsBaseKey = "WWT2";
    [Header("NoneKey")]
    public string NoneKey = "Не назначено";

    private const int ITEMS_CAPACITY = 26;
    ...
    public const string RewiredRefreshKey = "RewiredSetted5082017";
    ...
    void OnEnable()
    {
        ...
        Consumable12,Consumable21,Consumable22,Consumable31,Consumable32,CruiseControlItem1,CruiseControlItem2};
