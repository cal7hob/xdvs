...
public class Settings : HangarPage
{
    ...
    public tk2dUIToggleButton autoAim;
    ...
    protected override void Create()
    {
        ...
        autoAim.OnToggle += SetAutoAim;
        mouseControlledCamera.OnToggle += SetMouseControl;
    ...
    protected override void ProfileChanged()
    {
        ...
        autoAim.IsOn = (PlayerPrefs.GetInt("AutoAiming", 1) == 1);
    ...
    private void SetAutoAim(tk2dUIToggleButton _autoAim)
    {
        if (autoAim.IsOn)
        {
            mouseControlledCamera.IsOn = false;
        }
    }

    private void SetMouseControl(tk2dUIToggleButton _mouseControl)
    {
        if (_mouseControl.IsOn)
        {
            if (autoAim != null)
            {
                autoAim.IsOn = false;
    ...
    private void SaveParams()
    {
        ...
        PlayerPrefs.SetInt("AutoAiming", autoAim.IsOn ? 1 : 0);
        PlayerPrefs.Save();
