...
public static class HelpTools
{
    ...
    public static void FontNormalizerAR() { FontNormalizer(Interface.WWT2); }
    ...
    */
    ...
    public static bool Vector3Approximately(Vector3 a, Vector3 b, float tolerance = 0.01f)
    {
        if (Approximately(a.x, b.x, tolerance) && Approximately(a.y, b.y, tolerance) && Approximately(a.z, b.z, tolerance))
        {
            return true;
        }
        else
