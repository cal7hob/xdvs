...
public class Fullscreen : AbstractClassForButtons
{
    ...
    private static void GoFullscreen()
    {
        ...
        Dispatcher.Send(EventId.FullScreenStateChanged, new EventInfo_B(true));
    }

    private static void GoWindow()
    {
        Screen.SetResolution(960, 600, false);
        Dispatcher.Send(EventId.FullScreenStateChanged, new EventInfo_B(false));
    }
