...
public class MapSelectionScrollbar : MonoBehaviour
{
    ...
    public List<string> MapsAvailable { get; private set; }
    ...
    {
        Dispatcher.Send(EventId.MapSelectionAppeared, new EventInfo_B(true));
    }

    public void OnDisable()
    {
        isCentered = false;
        Dispatcher.Send(EventId.MapSelectionAppeared, new EventInfo_B(false));
    }
