...
public class SpecialOffersPage : MonoBehaviour
{
    ...
    [SerializeField]
    private tk2dTextMesh lblTimeLimitedSales;
    [SerializeField]
    private tk2dTextMesh lblRemains;
    [SerializeField]
    private GameObject remainsLayout;
    ...
    private void InitSaleBtn()
    {
        ...
        else if (lblRemains && GameData.allOffersList.Count > 0)
        {
    ...
    {
        var remain = GameData.allOffersList[0].Remain;
    ...
    public string GetSaleStickerText(int maxDiscount)
    {
        ...
        switch (GameData.CurInterface)
        {
            ...
            case Interface.WWT2: delimiter = " "; break;
                //default: delimiter = "\n"; break;
        }
