...
public class MoreGamesController : MonoBehaviour
{
    ...
    public List<GamePromo> gamesPromos = new List<GamePromo>();
    public GameObject button;
    private List<GamePromoButton> buttons = new List<GamePromoButton>();
    ...
    public static MoreGamesController instance;
