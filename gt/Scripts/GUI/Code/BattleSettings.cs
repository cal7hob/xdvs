...
public class BattleSettings : MonoBehaviour
{
    ...
    private float vehicleCameraDistance;
    ...
    void Awake()
    {
        ...
        vehicleCameraDistance = PlayerPrefs.HasKey("VehicleCameraDistance") ? PlayerPrefs.GetFloat("VehicleCameraDistance") : Settings.DEFAULT_VEHICLE_CAMERA_DISTANCE;
