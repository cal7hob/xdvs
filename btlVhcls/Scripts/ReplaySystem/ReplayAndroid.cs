...
internal class ReplayAndroid : ReplayBase
{
    ...
    public ReplayAndroid()
    {
        ...
        Everyplay.UploadDidComplete += EveryplayOnUploadDidComplete;
    }
    ...
    private void EveryplayOnUploadDidComplete(int videoId)
    {
        Dispatcher.Send(EventId.VideoUploadCompleted, new EventInfo_SimpleEvent());
    }
