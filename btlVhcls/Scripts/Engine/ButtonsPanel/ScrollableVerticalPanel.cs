...
public class ScrollableVerticalPanel : VerticalPanel {
    ...
    void VerticalAlign()
    {
        float layoutBottomPosition = HangarController.Instance.bottomGuiPanel.GetComponent<Renderer>().bounds.size.y;
        ...
        bottomMask.transform.position = new Vector3(bottomMask.transform.position.x, 
            HangarController.Instance.bottomGuiPanel.GetComponent<Renderer>().bounds.max.y, bottomMask.transform.position.z);
    }
    void LateUpdate()
    {
