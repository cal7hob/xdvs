...
public class Module_ButtonRecordVideo : InterfaceModuleBase
{
    ...
    [SerializeField] private ActivatedUpDownButton btn;
    [SerializeField] private GameObject menu;
    [SerializeField] private tk2dSlicedSprite recordIndicator;
    [SerializeField] protected Renderer sprBgRenderer;
    ...
    private void ShowMenu()
    {
        ...
        {
            xMin = GameData.CurSceneGuiCamera.WorldToScreenPoint(contextMenuBounds.min).x,
            xMax = GameData.CurSceneGuiCamera.WorldToScreenPoint(contextMenuBounds.max).x,
            yMin = GameData.CurSceneGuiCamera.WorldToScreenPoint(contextMenuBounds.min).y,
            yMax = GameData.CurSceneGuiCamera.WorldToScreenPoint(contextMenuBounds.max).y,
        };
    }
    ...
    private void StartRecording()
    {
        ...
        Dispatcher.Send(EventId.VideoStartRecording, new EventInfo_SimpleEvent());
    }
    ...
    private void StartBroadcasting()
    {
        ...
        menu.SetActive(false);
        Dispatcher.Send(EventId.VideoStartBroadcasting, new EventInfo_SimpleEvent());
    }
}
