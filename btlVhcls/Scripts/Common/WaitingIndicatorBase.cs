...
public class WaitingIndicatorBase : MonoBehaviour
{
    ...
    [SerializeField] protected string customPath;
    ...
    protected virtual void Start()
    {
        ...
        string path = !string.IsNullOrEmpty(customPath) ? customPath : string.Format("{0}/Textures/WaitingIndicator", GameData.CurInterface);
