...
public class SpecialOffersPage : MonoBehaviour
{
    ...
    public SpecialOfferPrefab consumableKitOfferPrefab;
    ...
    public static void BankOffersBtnClickHandler(tk2dUIItem uiItem)
    {
        ...
        GUIPager.SetActivePage("Bank", true);
    ...
    public static void ConsumableKitOffersBtnClickHandler(tk2dUIItem uiItem)
    {
        GUIPager.SetActivePage("ConsumablesPage");
        ConsumablesPage.Instance.SetTab(ConsumablesPage.Tab.Kits);
    }
    ...
    public string GetSaleStickerText(int maxDiscount)
    {
        ...
        switch (GameData.CurInterface)
        {
            ...
            case Interface.MetalForce: delimiter = " "; break;
            //default: delimiter = "\n"; break;
        }
