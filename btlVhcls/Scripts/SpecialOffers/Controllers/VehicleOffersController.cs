...
public class VehicleOffersController : SpecialOffersController<VehicleOffer>
{
    ...
    {
        GUIPager.SetActivePage("FreeTankDetails", false);
    }
...
#else
        lblFreeTankDetails.text = Localizer.GetText("lblFreeTankDetails", PriceLocalizationAgent.GetLocalizedString("xdevs.250_gold", lblFreeTankDetails, "lblBuyGold3"));
#endif
    }
}
