...
public class VipOffersController : SpecialOffersController<VipSpecialOffer>
{
    ...
    protected override void Awake()
    {
        ...
        Dispatcher.Subscribe(EventId.ProfileInfoLoadedFromServer, ProfileInfoChanged);
    }
    ...
    protected override void OnDestroy()
    {
        ...
        Dispatcher.Unsubscribe(EventId.ProfileInfoLoadedFromServer, ProfileInfoChanged);
    }
