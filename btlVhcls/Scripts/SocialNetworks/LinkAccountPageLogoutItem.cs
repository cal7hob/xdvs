...
class LinkAccountPageLogoutItem : MonoBehaviour
{
    public event Action LogoutSucceed = delegate { };
    
    [SerializeField] private GameObject logoutGroup;
    [SerializeField] private tk2dUIItem logoutButton;
    [SerializeField] private SocialUserInfoView socialUserInfoView;
