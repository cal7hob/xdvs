...
public class QuestsUI : MonoBehaviour
{
    ...
    public void MarkerizeQuestList()
    {
        ...
        foreach (Quest quest in QuestsInfo.Quests)  
        {
            ...
            questReward[i].SetMoneySpecificColorIfCan(quest.CurReward);
            i++;
        }
        ...
        goldReward.SetMoneySpecificColorIfCan(QuestsInfo.CurRewardForThreeQuests);
    }
    ...
    private void OnOpenPageButtonClick(tk2dUIItem btn)
    {
        GUIPager.SetActivePage("Quests", true);
        MarkerizeQuestList();
