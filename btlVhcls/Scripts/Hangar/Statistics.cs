...
public class Statistics : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        Dispatcher.Subscribe(EventId.GameCenterDisabled, GameCenterDisabled);
    }

    private void OnDestroy()
    {
        Dispatcher.Unsubscribe(EventId.ClanChanged, OnClanChanged);
        Dispatcher.Unsubscribe(EventId.GameCenterDisabled, GameCenterDisabled);
        Instance = null;
    }
    ...
    {
        GUIPager.SetActivePage("Statistics", true);
    ...
    public void SetupButtons()
    {
        ...
        {
            if (GUIPager.ActivePageName != "CommonStat" && GameData.IsGame(Game.IronTanks))
            {
