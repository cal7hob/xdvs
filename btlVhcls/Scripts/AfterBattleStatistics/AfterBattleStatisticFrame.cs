...
public class AfterBattleStatisticFrame : MonoBehaviour
{
    ...
    {   
        ...
        row.statValue.text = MiscTools.GetCultureSpecificFormatOfNumber(statValue);
    ...
    public void FillStatisticFrame()
    {
        ...
        AccuracyRow = CreateRow((br.Accuracy + br.AccuracySaclos) / 2, "lblAccuracyInBattle");
        DeathsRow = CreateRow(br.deaths, "lblDeathsInBattle");
        FragsRow = CreateRow(br.frags, "lblFragsInBattle");
        HitsAmountRow = CreateRow(br.hits + br.hitsSaclos, "lblHitsInBattle");
        MileageRow = CreateRow((int)br.mileage, "lblMileageInBattle");
        ShotsAmountRow = CreateRow(br.shoots + br.shootsSaclos, "lblShootsInBattle");
