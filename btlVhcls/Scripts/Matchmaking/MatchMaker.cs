    ...
    public static class MatchMaker
    {
            ...
            int group)
        {
            ...
            if (!string.IsNullOrEmpty(lastSelectedRoom))
            {
                ...
                {
                    if (roomInfo.Name == lastSelectedRoom && (int)roomInfo.CustomProperties["gm"] == (int)GameData.Mode && TotalPlacesBusyInRoom(roomInfo) < GameData.maxPlayers)
                    {
        ...
        {
            int result = roomInfo.PlayerCount + GetPlaceReserve(roomInfo) + TotalBotsInRoom(roomInfo);
        ...
        {
            int busy = roomInfo.PlayerCount + GetPlaceReserve(roomInfo);
