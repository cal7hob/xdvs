...
public class BattleStatisticsManager : MonoBehaviour
{
    ...
    private static readonly Dictionary<string, int> battleStats = new Dictionary<string, int>
    {
        ...
        { "TakenHits_ATGW", 0 },
        { "TakenHits_AGS", 0 },
        { "TakenHits_MachineGun", 0 },
        { "GivenDamage", 0 },
        { "TakenDamage", 0 },
        { "GivenDamage_SACLOS", 0 },
        { "GivenDamage_ATGW", 0 },
        { "GivenDamage_AGS", 0 },
        { "GivenDamage_MachineGun", 0 },
        { "TakenDamage_SACLOS", 0 },
        { "TakenDamage_ATGW", 0 },
        { "TakenDamage_AGS", 0 },
        { "TakenDamage_MachineGun", 0 },
        { "Deaths", 0 },
        { "Frags", 0 },
        { "Accuracy", 0 },
        { "Accuracy_SACLOS", 0 },
    ...
    public static void CalcOverallBattleStatistics()
    {
        ...
        AddDataToOverallBattleStats("TotalShoots_ATGW", "Shoots_ATGW");
        AddDataToOverallBattleStats("TotalShoots_AGS", "Shoots_AGS");
        AddDataToOverallBattleStats("TotalShoots_MachineGun", "Shoots_MachineGun");
        AddDataToOverallBattleStats("TotalHits_SACLOS", "Hits_SACLOS");
        AddDataToOverallBattleStats("TotalHits_ATGW", "Hits_ATGW");
        AddDataToOverallBattleStats("TotalHits_AGS", "Hits_AGS");
        AddDataToOverallBattleStats("TotalHits_MachineGun", "Hits_MachineGun");
        ...
        AddDataToOverallBattleStats("TotalGivenDamage_ATGW", "GivenDamage_ATGW");
        AddDataToOverallBattleStats("TotalGivenDamage_AGS", "GivenDamage_AGS");
        AddDataToOverallBattleStats("TotalGivenDamage_MachineGun", "GivenDamage_MachineGun");
        ...
        OverallBattleStats["OverralAccuracy_ATGW"] = CalcOverallAccuracy(OverallBattleStats["TotalShoots_ATGW"], OverallBattleStats["TotalHits_ATGW"]);
        OverallBattleStats["OverralAccuracy_AGS"] = CalcOverallAccuracy(OverallBattleStats["TotalShoots_AGS"], OverallBattleStats["TotalHits_AGS"]);
        OverallBattleStats["OverralAccuracy_MachineGun"] = CalcOverallAccuracy(OverallBattleStats["TotalShoots_MachineGun"], OverallBattleStats["TotalHits_MachineGun"]);
    ...
    public static string GetOverallBattleStatStringSafely(string key)
    {
        if (OverallBattleStats.ContainsKey(key))
            return MiscTools.GetCultureSpecificFormatOfNumber(OverallBattleStats[key]);
    ...
    private static void CountGivenDamage(EventId id, EventInfo ei)
    {
        ...
        switch (shellType)
        {
            case GunShellInfo.ShellType.MachineGun:
                BattleStats["GivenDamage_MachineGun"] += damage;
                BattleStats["Hits_MachineGun"] += hits;
                return;

            case GunShellInfo.ShellType.Grenade_AGS:
                BattleStats["GivenDamage_AGS"] += damage;
                BattleStats["Hits_AGS"] += hits;
                return;

            case GunShellInfo.ShellType.Missile_ATGW:
                BattleStats["GivenDamage_ATGW"] += damage;
                BattleStats["Hits_ATGW"] += hits;
                return;

            case GunShellInfo.ShellType.Missile_SACLOS:
                BattleStats["GivenDamage_SACLOS"] += damage;
                BattleStats["Hits_SACLOS"] += hits;
                return;

            case GunShellInfo.ShellType.Usual:
                BattleStats["GivenDamage"] += damage;
                BattleStats["Hits"] += hits;
                return;
    ...
    private static void CountShoots(EventId id, EventInfo ei)
    {
        ...
        {
            case GunShellInfo.ShellType.MachineGun:
                BattleStats["Shoots_MachineGun"]++;
                return;

            case GunShellInfo.ShellType.Grenade_AGS:
                BattleStats["Shoots_AGS"]++;
                return;

            case GunShellInfo.ShellType.Missile_ATGW:
                BattleStats["Shoots_ATGW"]++;
                return;
    ...
    private static void CalcAccuracy()
    {
        ...
        if (BattleStats["Shoots_ATGW"] > 0)
            BattleStats["Accuracy_ATGW"] = (int)(BattleStats["Hits_ATGW"] * 100f / BattleStats["Shoots_ATGW"]);

        if (BattleStats["Shoots_AGS"] > 0)
            BattleStats["Accuracy_AGS"] = (int)(BattleStats["Hits_AGS"] * 100f / BattleStats["Shoots_AGS"]);

        if (BattleStats["Shoots_MachineGun"] > 0)
            BattleStats["Accuracy_MachineGun"] = (int)(BattleStats["Hits_MachineGun"] * 100f / BattleStats["Shoots_MachineGun"]);
    }
    ...
    public static void WriteMileage()
    {
