...
namespace Disconnect
{
    public class BattleConnectManager : MonoBehaviour
    {
        ...
        {
            get { return PhotonNetwork.isMasterClient && PhotonNetwork.connected; }
        }
        ...
        {
            if (!IsMasterClient || PhotonNetwork.otherPlayers.Length == 0)
        ...
        {
            MessageBox.HideHardMessage();//Hide info window if exists
