...
public class ThirdPartyAdsManager : MonoBehaviour
{
    ...
    public static void Show(AdsShowingMode targetPlace, Action closingCallback)
    {
        ...
        {
            instance.showingServices[0].ShowInterstitial();
            return;
        }
    ...
    private void ShowingCallback(bool success)
    {
        ...
        if (showingServices.Count > 1)
        {
            ...
            showingServices[0].ShowInterstitial();
    ...
    public static ThirdPartyAdsService GetServiceWithName(string platform)
    {
        return instance.services.FirstOrDefault(service => service.ParsingKey == platform);
    }
}
