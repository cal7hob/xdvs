...
public static class ModifyIosIcons
{
	public static void ModifyIcons(string path)
    {
        ...
        File.Copy (string.Format("{0}/Game_Source/Icons/{1}/{2}", Application.dataPath, GameData.CurInterface, "20.png"), string.Format("{0}/{1}", fullDestDir, "20.png"));
        ...
        File.Copy (string.Format("{0}/Game_Source/Icons/{1}/{2}", Application.dataPath, GameData.CurInterface, "60.png"), string.Format("{0}/{1}", fullDestDir, "60.png"));
        ...
        //Add absebtee icons
        jsonObject.images.Add(new IconJsonObject("20x20", "iphone", "40.png", "2x"));
        jsonObject.images.Add(new IconJsonObject("20x20", "iphone", "60.png", "3x"));
        ...
        jsonObject.images.Add(new IconJsonObject("20x20", "ipad", "20.png", "1x"));
        jsonObject.images.Add(new IconJsonObject("20x20", "ipad", "40.png", "2x"));
