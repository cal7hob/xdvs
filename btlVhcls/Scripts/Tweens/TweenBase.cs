...
public class TweenBase : MonoBehaviour, Tween
{
    ...
    public bool restartIfInProgress = false;//Если true - то при попытке запустить повторно проигрываемую в данный момент анимацию - начинаем сначала, иначе игнорируем
