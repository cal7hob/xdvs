...
public class GameManager : MonoBehaviour
{
    public enum MapId
    {
        ...
        Hangar_CodeOfWar_Standart = 21,
        Hangar_CodeOfWar_Premium = 22,

        //CodeOfWar
        scnb_CodeOfWar_1 = 701,
        scnb_CodeOfWar_2 = 702,
        scnb_CodeOfWar_3 = 703,
        scnb_CodeOfWar_4 = 704,
        scnb_CodeOfWar_5 = 705,
        scnb_CodeOfWar_6 = 706,

        random_map = 1000
    }

    public const string PHOTON_ROOM_VERSION = "v7.31";

    public static Dictionary<Interface, Dictionary<bool, string>> photonIds = new Dictionary<Interface, Dictionary<bool, string>>()
    {
        {Interface.CodeOfWar,new Dictionary<bool,string>()
            {
                { false, "3b68ccd1-6a35-4d12-9e29-cd3d28bd1527" }, // NORMAL_PHOTON_APPLICATION_ID
				{ true,  "3b68ccd1-6a35-4d12-9e29-cd3d28bd1527" }  // SPECIAL_PHOTON_APPLICATION_ID - for cheaters
			}
        },
    };
    ...
    public static readonly ObscuredFloat CRIT_DAMAGE_RATIO = 3f;
    public static readonly ObscuredFloat NORM_DAMAGE_RATIO = 1f;
    ...
    public static void SetMainVehicle(UserVehicle vehicle)
    {
        ...
        mainVehicleDecalId = ProfileInfo.IsBattleTutorial ? 1 : vehicle.Upgrades.DecalId;
    }
    ...
    public void ConnectToPhoton()
    {
        ...
        {
            MatchMaker.CreateRoom((int)MapId.scnb_CodeOfWar_1, 1);
            return;
        }
    ...
    {
        PoolManager.PreWarm<ParticleEffect>(vehicle.hitPrefabPath, 25);
        PoolManager.PreWarm<ParticleEffect>(vehicle.terrainHitPrefabPath, 25);
        PoolManager.PreWarm<ParticleEffect>(vehicle.shotPrefabPath, 25);
      //  PoolManager.PreWarm<Shell>(vehicle.shellPrefabPath, 25);
