...
namespace Http
{
    ...
    class Manager : MonoBehaviour
    {
        ...
        {
            { Interface.CodeOfWar, new List<Server> {
                    new Server (WorldRegion.Debug,  "http",  "cow.scifi-tanks.com", "d"),
                    new Server (WorldRegion.Europe, "https", "cow-eu.extreme-developers.com", "e"),
                    new Server (WorldRegion.Asia,   "https", "cow-sg.extreme-developers.com", "a"),
                }
            },
        };
        #endregion
