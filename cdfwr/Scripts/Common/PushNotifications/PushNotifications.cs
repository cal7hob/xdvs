...
//    }
    ...
    public IEnumerator SettingLocalNotifications()
    {
        ...
        StartCoroutine(pusher.SchedulingLocalNotifications());
#endif

        Debug.Log("PushNotifications: On pushes scheduled, Quit game");
        OnPushesScheduled();
        IsScheduled = true;
    }
...
#if !UNITY_EDITOR && (UNITY_ANDROID || UNITY_IOS || UNITY_WP8 || UNITY_WP8_1 || UNITY_WSA || UNITY_WSA_8_0 || UNITY_WSA_8_1 || UNITY_WSA_10_0)
        pusher.Initialize();
