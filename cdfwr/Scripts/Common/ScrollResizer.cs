...
public class ScrollResizer : MonoBehaviour
{
    ...
    public float ScrollbarLenghtFullHd = 342f;
    public float ScrollableVisibleAreaFullHd = 230f;

    void Awake()
    {
        awakeIsCalled = true;
        Dispatcher.Subscribe(EventId.ResolutionChanged, ResizeScreen);
    ...
    void OnDisable()
    {
        Dispatcher.Unsubscribe(EventId.ResolutionChanged, ResizeScreen);
        awakeIsCalled = false;
