...
public enum Game : ulong
{
    ...
    ApocalypticCars = 0x00010000,   // 0000 0000 0000 0100
    BattleOfWarplanes = 0x00100000,
    BattleOfHelicopters = 0x01000000,
    CodeOfWar = 0x00000002,
    Armada = 0x00000020,
    TanksVsRobots = 0x00000200,
    ...
    CodeOfWarAmazon = CodeOfWar | AmazonBuild,
    TanksVsRobotsAmazon = TanksVsRobots | AmazonBuild,
...
public class GameData : MonoBehaviour
{
    ...
    public static ObscuredFloat BurstInterval = 0.01f;
    ...
    public const int TUTORIAL_VEHICLE_ID = 1; // TODO: поменять на актуальный.
    public const string UNKNOWN_FLAG_NAME = "xx";
    public const string CONSUMABLES_SPRITE_FRAMED_VERSION_SUFFIX = "";
    ...
    public static string GetInterfaceShortName(Interface customInterface)
    {
        ...
        {
            case Interface.CodeOfWar: return "COW";
    ...
    public static string tapjoyIosEngagementId;
    public static string tapjoyAndroidEngagementId;
    public static ObscuredInt tapjoyEngagementLevel;
    ...
    public static List<SpecialOffer> allOffersList = new List<SpecialOffer>();
    ...
    public static Interface CurInterface
    {
        get
        {
            ...
            {
                if (UnityEditor.PlayerSettings.applicationIdentifier == androidBundleIds[Game.CodeOfWar] ||
                    UnityEditor.PlayerSettings.applicationIdentifier == androidBundleIds[Game.CodeOfWarAmazon])
                {
                    return Interface.CodeOfWar;
                }
                else
                {
    ...
    public static Dictionary<Game, string> androidBundleIds = new Dictionary<Game, string>() {
        {Game.CodeOfWar,              "com.extremedevelopers.codeofwar"},
        {Game.CodeOfWarAmazon,        "com.extremedevelopers.codeofwar"},
        ...
        {Game.TanksVsRobots, "com.extremedevelopers.tanksvsrobots" },
        {Game.TanksVsRobotsAmazon, "com.extremedevelopers.tanksvsrobots" },
    ...
    private bool LoadServerOptions(JsonPrefs options)
    {
        ...
        if (options.Contains("iosEngagementId"))
            tapjoyIosEngagementId = options.ValueString("iosEngagementId");
        else
            Debug.Log("TapJoy: There is no \"iosEngagementId\" section in option from server!");

        if (options.Contains("androidEngagementId"))
            tapjoyAndroidEngagementId = options.ValueString("androidEngagementId");
        else
            Debug.Log("TapJoy: There is no \"androidEngagementId\" section in option from server!");

        if (options.Contains("engagementLevel"))
            tapjoyEngagementLevel = options.ValueInt("engagementLevel");
        else
            Debug.Log("TapJoy: There is no \"engagementLevel\" section in option from server!");

        Debug.LogFormat("Tapjoy Android SDK: {0}, iOS SDK: {1}, GCM key: {2}", tapJoyAndroidSdkKey, tapJoyIosSdkKey, tapJoyAndroidGcmSenderId);
        Debug.LogFormat("Tapjoy Engagement Ids: iOS: {0}, Android: {1}", tapjoyIosEngagementId, tapjoyAndroidEngagementId);
