...
public static class HelpTools
{
    ...
    public static void SaveNativeResolution()
    {
        NativeWidth = tk2dCamera.Instance.nativeResolutionWidth;
        NativeHeight = tk2dCamera.Instance.nativeResolutionHeight;
    }

    public static Vector2 GetScreenRelPos(Vector2 deltaPos)
    {
    ...
    public static void FontNormalizerAR() { FontNormalizer(Interface.CodeOfWar); }
