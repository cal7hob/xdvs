...
public class WaitingIndicatorBase : MonoBehaviour
{
    ...
    [SerializeField]
    protected tk2dSlicedSprite circle;
    [SerializeField]
    protected float circleSpeed = -1.5f;
    [SerializeField]
    protected tk2dCameraAnchor[] anchors;
    [SerializeField]
    protected List<Parent> parents;//родители на все случаи жизни - заполнять енам ParentType, накидывать в префаб
