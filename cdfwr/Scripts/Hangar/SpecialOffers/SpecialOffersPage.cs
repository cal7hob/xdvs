...
public class SpecialOffersPage : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        Dispatcher.Subscribe(EventId.SpecialOffersInitialized, Init);
    }
    ...
    void OnDestroy()
    {
        ...
        Dispatcher.Unsubscribe(EventId.SpecialOffersInitialized, Init);
    }
    ...
    public void FramesReposition()
    {
        ...
        {
            if (GUIPager.ActivePageName == PageName)
            {
                GUIPager.Back();
            }
    ...
    public string GetSaleStickerText(int maxDiscount)
    {
        ...
        switch (GameData.CurInterface)
        {
            ...
            case Interface.CodeOfWar: delimiter = ""; break;
                //default: delimiter = "\n"; break;
        }
        return string.Format("{0}-{1}{2}{3}{4}% ", HelpTools.To2DToolKitColorFormatString(saleWordCustomColor), delimiter, HelpTools.To2DToolKitColorFormatString(percentCustomColor), maxDiscount, HelpTools.To2DToolKitColorFormatString(percentSymbolCustomColor));
    }
}
