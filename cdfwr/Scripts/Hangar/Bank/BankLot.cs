...
public class BankLot : BankLotBase
{
    ...
    [SerializeField]
    private OldPriceRenderer oldPriceRenderer;
    [SerializeField]
    private SaleSticker saleSticker;
    [SerializeField]
    private tk2dTextMesh localizedPrice;
    [SerializeField]
    private tk2dSlicedSprite mainSprite;


    [SerializeField]
    private HorizontalLayout[] horizontalLayouts;
    [SerializeField]
    private Color extraFreeCustomColor = Color.white;
    [SerializeField]
    private GameObject[] objectsActivatedForGold;
    [SerializeField]
    private GameObject[] objectsActivatedForSilver;
