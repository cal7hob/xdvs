...
public class VehicleInfo : HelpTools.IDictTransformable, IShopItem
{
    ...
    public ObscuredInt baseMagazine;
    ...
    {
        get { return ProfileInfo.vehicleUpgrades != null && ProfileInfo.vehicleUpgrades.ContainsKey(id); }
    }
    ...
    public int GetMaxUpgradeLevel(TankModuleInfos.ModuleType moduleType)
    {
        switch (moduleType)
        {
    ...
    public void LoadFromDictionary(JSONObject dict)
    {
        ...
        baseReloadTime = data.ValueFloat("baseReloadTime");

        baseMagazine = data.ValueInt("baseMagazine");
    ...
    public JSONObject ToDictionary()
    {
        ...
        dict["baseMagazine"] = (int)baseMagazine;
        dict["baseReloadTime"] = baseReloadTime;
