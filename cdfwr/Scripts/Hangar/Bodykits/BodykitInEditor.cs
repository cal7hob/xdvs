...
public class BodykitInEditor : MonoBehaviour, HelpTools.IDictTransformable
{
    ...
    public ObscuredFloat reloadTimeGain;
    ...
    public Dictionary<string, object> ToDictionary()
    {
        ...
        Dictionary<string, object> dict = new Dictionary<string, object>
        {
            ...
            {"reloadTimeGain",reloadTimeGain },
            {"magazineGain", magazineGain }
        };
    ...
    public void LoadFromDictionary(Dictionary<string, object> dict)
    {
        ...
        reloadTimeGain = data.ValueFloat("reloadTimeGain");
        magazineGain = data.ValueFloat("magazineGain");
