...
public class VehicleShopItemCell : ShopItemCell
{
    ...
    [SerializeField] private tk2dBaseSprite[] vehicleTypeSprites;
    [SerializeField] private bool useColoringForVehicleTypeIcons = false;
    ...
    {
        base.Set<VehicleShopItemCell>(shopItem);
        ...
        //HelpTools.SetSpriteToAllSpritesInCollection(vehicleTypeSprites, string.Format("vehicleTypeIcon_{0}", info.tankType.ToString().ToLower()));
        //if(useColoringForVehicleTypeIcons && info.vehicleGroup <= colorsForGroups.Length)
        //    HelpTools.SetColorToAllSpritesInCollection(vehicleTypeSprites, colorsForGroups[info.vehicleGroup - 1]);
