...
public class BonusItem : MonoBehaviour
{
    ...
    void OnDestroy()
    {
        ...
        if (PhotonNetwork.isMasterClient && isMapBonus)
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        VehicleController veh = other.transform.GetComponentInParent<SoldierController>();
        if (veh == null || !veh.IsAvailable || veh.IsDead)
            return;
