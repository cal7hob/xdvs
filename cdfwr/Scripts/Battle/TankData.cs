...
public class TankData
{
    ...
    public bool vip;
    public ObscuredString clanName;
    ...
    private Dictionary<string, object> battleParameters = new Dictionary<string, object>(32);
...
)
    {
        ...
        reloadTime = hangarParameters[VehicleInfo.VehicleParameter.ReloadTime];
