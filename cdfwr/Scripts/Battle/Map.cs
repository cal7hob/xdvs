...
{
    [SerializeField] private GameObject levelObjectsRoot;
    ...
    [SerializeField] private Transform cameraInitialPlace;
    ...
    public static GameObject LevelObjectsRoot { get { return Instance != null ? Instance.levelObjectsRoot : null; } }
    public float CameraClippingDistance { get { return cameraClippingDistance; } }

    public static Transform CameraInitialPlace
    {
        get
        {
            if (!ReferenceEquals(Instance.cameraInitialPlace, null))
            {
                return Instance.cameraInitialPlace;
            }

            Debug.LogWarning("camera initial position did not set");
