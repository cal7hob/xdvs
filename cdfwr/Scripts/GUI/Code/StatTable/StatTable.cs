...
public class StatTable : MonoBehaviour
{
    ...
    private static int ROW_COUNT = GameData.maxPlayers;
    ...
    public GameObject hastenRespBtn;
    ...
    [SerializeField]
    private tk2dTextMesh lblMyTeamScore;
    [SerializeField]
    private tk2dTextMesh lblEnemyTeamScore;
    [SerializeField]
    private Transform tableBody;
    [SerializeField]
    private Transform tableBody2;
        ...
        switch (state)
        {
            case TableState.AfterDeath:
                    ...
                    BattleController.Instance.BattleMode == GameData.GameMode.Deathmatch && BattleController.DeathMatchType2)
                {
                    ...
                    hastenRespBtn.SetActive(false);
                }
                else
                {
                    exitBtn.SetActive(false);
                    hastenRespBtn.SetActive(true);
    ...
    public void OnExitToHangarClick()
    {
        BattleSoundManager.Instance.PlaySound(BattleSoundManager.Instance.buttonClickSound);
