// SpaceJet screen https://monosnap.com/file/NVFP8DnpdrvgWY0iQplW7HWLX7hTD2
using System;
using UnityEngine;
...
public class DeltaProgressBar : ProgressBar
{
    ...
    [SerializeField]
    private float deltaSpriteLeftBorder = 0;//Без учета скейла(как бордер слайсед спрайта). Сколько пикселей от края до начала неградиентной части части
    ...
    [SerializeField]
    private tk2dBaseSprite deltaSquare;
    ...
    [SerializeField]
    private Color squareColorPositive;
    [SerializeField]
    private Color squareColorNegative;
    ...
    public void Repaint()
    {
        ...
        tk2dSlicedSprite enabledSprite = delta > 0 ? deltaSpritePos : deltaSpriteNeg;
        tk2dSlicedSprite disabledSprite = delta > 0 ? deltaSpriteNeg : deltaSpritePos;
        ...
        deltaLabel.color = delta > 0 ? positiveColor : negativeColor;
        deltaSquare.color = delta > 0 ? squareColorPositive : squareColorNegative;
